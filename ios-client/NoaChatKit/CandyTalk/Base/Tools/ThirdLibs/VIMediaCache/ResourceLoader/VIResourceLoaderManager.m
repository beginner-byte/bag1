...
- (BOOL)resourceLoader:(AVAssetResourceLoader *)resourceLoader shouldWaitForLoadingOfRequestedResource:(AVAssetResourceLoadingRequest *)loadingRequest  {
    ...
    if ([resourceURL.absoluteString hasPrefix:kCacheScheme]) {
        ...
        NSData *encrytedData = [NSData dataWithContentsOfURL:resourceURL];
//        NSData * encryptfileData = [[ZEncryptManager shareEncryManager] decrypt:encrytedData];
        NSData * encryptfileData = [[EncryptManager shareEncryManager] decrypt:encrytedData];
        if (encryptfileData) {
            [loadingRequest.dataRequest respondWithData:encryptfileData];
