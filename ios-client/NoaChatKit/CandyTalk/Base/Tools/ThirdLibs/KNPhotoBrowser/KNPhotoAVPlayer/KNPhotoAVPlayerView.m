...
- (void)playerOnLinePhotoItems:(KNPhotoItems *)photoItems placeHolder:(UIImage *_Nullable)placeHolder{
    ...
    if ([photoItems.url hasPrefix:@"http"]) {
        AVURLAsset *asset = [AVURLAsset URLAssetWithURL:[NSURL URLWithString:photoItems.url] options:nil];
        VIResourceLoaderManager *resourceLoaderManager = [VIResourceLoaderManager new];
        self.resourceLoaderManager = resourceLoaderManager;
        _item = [resourceLoaderManager playerItemWithURL:asset.URL];
        VICacheConfiguration *configuration = [VICacheManager cacheConfigurationForURL:asset.URL];
