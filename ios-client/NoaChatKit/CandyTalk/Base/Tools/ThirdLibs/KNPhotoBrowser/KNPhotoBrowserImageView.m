...
- (void)imageWithUrl:(NSURL *)url
    ...
    [_imageView sd_setImageWithURL:url placeholderImage:placeHolder options:SDWebImageAllowInvalidSSLCertificates context:nil progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
        ...
        [weakSelf.scrollView setZoomScale:1.f animated:true];
        if(!error){
