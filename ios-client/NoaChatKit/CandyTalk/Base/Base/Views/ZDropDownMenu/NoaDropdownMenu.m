...
#import "NoaDropdownMenu.h"

@interface NoaDropdownMenu() <UITableViewDelegate, UITableViewDataSource>
...
@implementation NoaDropdownMenu
{
...
- (void)showDropDown{   // 显示下拉列表
    for (UIView * view in self.superview.subviews) {
        if ([view isKindOfClass:[NoaDropdownMenu class]]) {
            if (view != self) {
                [(NoaDropdownMenu *)view hideDropDown];
            }
        }
    }
