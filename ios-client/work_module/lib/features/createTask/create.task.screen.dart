            ...
            child: Column(
              ...
              children: [
                ...
                _sectionCard(
                  ...
                  child: Obx(() {
                    final selectedMembers = controller.selectedAssignees;
                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        OutlinedButton.icon(
                          onPressed: controller.selectAssignees,
                          icon: const Icon(Icons.group_add_outlined),
                          label: Text(S.of(context).teamDetailSelectAssignees),
                        ),
                        if (selectedMembers.isNotEmpty) SizedBox(height: 12.h),
                        Wrap(
                          spacing: 8.w,
                          runSpacing: 8.h,
