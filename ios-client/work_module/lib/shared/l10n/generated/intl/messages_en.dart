...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "taskDetailGroupChat": MessageLookupByLibrary.simpleMessage(
      "Task group chat",
    ),
    "taskDetailOpenGroup": MessageLookupByLibrary.simpleMessage(
      "Open group chat",
    ),
    "taskDetailRetryGroup": MessageLookupByLibrary.simpleMessage(
      "Create group chat",
    ),
    "taskDetailDelete": MessageLookupByLibrary.simpleMessage("Delete task"),
    ...
    "taskDetailAddAssignees": MessageLookupByLibrary.simpleMessage(
      "Add assignees",
    ),
